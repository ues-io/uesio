...
A redux middleware is in charge of dealing with asynchronous actions. Indeed the reducer expect as parameter an plain javascript object and not a promise.
