...
In contrast to the [redux style guide](https://redux.js.org/style-guide/style-guide), not only plain JavaScript object are stored in the redux store but API as well.
