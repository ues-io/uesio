...
type Collection struct {
	...
	CustomMetadata        string                            `yaml:"customMetadata,omitempty" json:"uesio/studio.custommetadata"`
...
func (c *Collection) MarshalYAML() (interface{}, error) {
	c.IntegrationRef = removeDefault(localize(c.IntegrationRef, c.Namespace), "")
