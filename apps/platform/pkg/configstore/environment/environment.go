...
var configValues = map[string]string{
	...
	"uesio/core.platform_authsource_type":         GetEnv("UESIO_PLATFORM_AUTHSOURCE_TYPE", ""),
	"uesio/core.platform_datasource_type":         GetEnv("UESIO_PLATFORM_DATASOURCE_TYPE", "uesio.postgresio"),
	"uesio/core.platform_filesource_type":         GetEnv("UESIO_PLATFORM_FILESOURCE_TYPE", "uesio.s3"),
