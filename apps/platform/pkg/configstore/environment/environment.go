...
var configValues = map[string]string{
	...
	"uesio/core:platform_authmethod_type":        os.Getenv("UESIO_PLATFORM_AUTHMETHOD_TYPE"),
	...
	"uesio/core:platform_authmethod_credentials": os.Getenv("UESIO_PLATFORM_AUTHMETHOD_CREDENTIALS"),
