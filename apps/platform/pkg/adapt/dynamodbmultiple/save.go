...
func getDeletesForChange(delete adapt.DeleteRequest, collectionMetadata *adapt.CollectionMetadata) (map[string]interface{}, error) {
...
func getUpdatesForChange(change adapt.ChangeRequest, collectionMetadata *adapt.CollectionMetadata) (map[string]interface{}, map[string]interface{}, error) {
