...
func HandleMultiCollectionReferences(connection Connection, referencedCollections ReferenceRegistry,
	...
	return LoadLooper(connection, "uesio/core.common", common.IDMap, common.Fields, common.GetMatchField(), session, func(refItem meta.Item, matchIndexes []ReferenceLocator, ID string) error {
