...
export default function ${signupMethodName}_resetpassword(bot: ListenerBotApi) {
	const namespace = bot.getNamespace()
	const redirect = "/site/app/uesio/core/changepassword?signupmethod=" + namespace + "${signupMethodName}"
