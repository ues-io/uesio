...
const ListMenu: definition.UtilityComponent<MenuButtonUtilityProps<unknown>> = (
  ...
  const classes = isOpen
    ? styles.useUtilityStyleTokens(StyleDefaults, props, "uesio/io.listmenu")
    : NoStyle
        ...
        <FloatingPortal>
          <FloatingFocusManager context={floating.context} modal={false}>
            <div
              ...
              {...getFloatingProps()}
            >
              <div id={`floatingMenu-${id}`} className={classes.menuheader}>
                ...
                {items
                  ...
                  .map((item, index) => (
                    <div
                      className={styles.cx(
                        classes.menuitem,
                        activeIndex === index && classes.highlighted,
                      )}
                      key={getItemKey(item)}
