...
function getPath(
	...
	if (workspace && workspace.app && workspace.name) {
		if (isimported) return "" //TO-DO must be implemented at the moment this don't do anything `/app/${workspace.app}/workspace/${workspace.name}/bundlecollections/${parts[0]}/${parts[1]}`
