    ...
    displayConditions: [
      {
        field: "type",
        operator: "IN",
        values: ["fieldValue", "paramValue", "mergeValue", "hasConfigValue"],
        type: "fieldValue",
      },
    ],
    onChange: [
...
export const getDisplayConditionLabel = (
  ...
  switch (condition.type) {
    case "fieldValue":
      ...
      else if (condition.values) details += condition.values.length + " values"
    ...
    case "paramIsNotSet":
      ...
      break
    case "group":
      return `${condition.type.toLocaleUpperCase()}: ${condition.conjunction}`
  }
...
const addCondition =
  ...
  ({ context, path, items }: ListPropertyActionOptions) => {
    ...
    if (
      ...
      conditionsArray = get(context, targetPath) as component.DisplayCondition[]
    }
    add(
      context,
...
const getDisplayConditionChildren = (
  ...
  return (
    <>
      {groupConditions.map(
        (conditionOnGroup: component.DisplayCondition, secindex: number) => {
          ...
          return (
            <ListPropertyItem
              ...
              displayTemplate={getDisplayConditionLabel(conditionOnGroup)}
...
): ComponentProperty[] => [
  {
    ...
    items: {
      properties: (record: wire.PlainWireRecord) =>
        getDisplayConditionProperties(record as component.DisplayCondition),
