...
import { FieldMetadata, FieldValue } from "libs/ui/src/wireexports"

type ParamPickerDefinition = {
	fieldId: string
	viewIdField?: string
...
const ParamPicker: definition.UC<ParamPickerDefinition> = (props) => {
	...
	const params = api.view.getViewDef(context.getViewId() || "")
		?.params as FieldValue
