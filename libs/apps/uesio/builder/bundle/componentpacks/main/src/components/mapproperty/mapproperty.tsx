      ...
      action: () =>
        set(
          ...
          propertyPath.addLocal(
            property.defaultKey + (Math.floor(Math.random() * 60) + 1),
          ),
            ...
            >
              ...
              >
                <BuildActionsArea context={context}>
                  <DeleteAction context={context} path={itemPath} />
                  <MoveActions context={context} path={itemPath} />
                  <CloneKeyAction context={context} path={itemPath} />
                </BuildActionsArea>
              </ExpandPanel>
            </PropNodeTag>
          )
