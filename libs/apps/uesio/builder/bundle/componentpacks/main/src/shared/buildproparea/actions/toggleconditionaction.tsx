...
import { builder, api, signal, definition, component } from "@uesio/ui"
...
> = (props) => {
	...
	const wire = api.wire.useWire(wireName || "", props.context)
	...
	const clickHandler =
		signals &&
		signals.length &&
		api.signal.getHandler(signals, props.context)
