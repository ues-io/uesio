...
component.registry.registerBuilder("uesio","wire",Wire,WirePropertyDefinition)
component.registry.registerBuilder("uesio","view", component.View ,ViewPropertyDefinition)
